...
🧭 Spatial & Scientific Computing<br>
&nbsp;&nbsp;🌍 Google Earth Engine + Python — Extraction, analyse, temporalisation d’images satellites.<br>
&nbsp;&nbsp;🗺️ GeoPandas, xarray, rasterio — Construction d’indicateurs, intersections, rasterisation avancée.<br>
&nbsp;&nbsp;🔭 Environmental Indicators — Biodiversité, stress hydrique, mobilité, risques naturels.<br>

🖥️ Développement Web & APIs<br>
&nbsp;&nbsp;🚀 FastAPI lover — Auth OAuth2, parsing propre, middlewares, architecture scalable.<br>
&nbsp;&nbsp;💾 MongoDB & Repos — Structures claires, modèles Pydantic, ingestion de données.<br>
&nbsp;&nbsp;👓 Dash & Front-End Engineering — Dashboards dynamiques, intégration GA/GAds, UX data-driven.<br>

🤖 Automation & DevOps<br>
&nbsp;&nbsp;🔁 Prefect Flows — Recalculs massifs, orchestration, pipelines modulaires.<br>
&nbsp;&nbsp;🔄 CI/CD Friendly — GitLab CI, tests automatiques, builds pour Dash/React.<br>
&nbsp;&nbsp;🪢 n8n Automation — Assemblage d’APIs, automatisation financière & data analysis.<br>

🕸️ Scraping & Data Acquisition<br>
&nbsp;&nbsp;🕷️ Custom Scrapers (Selenium) — Architecture modulaire pour extraction auto (Tesla Finder).<br>
&nbsp;&nbsp;🔎 HTML Parsing Clean — Normalisation, classifiers dynamiques, scoring autos.<br>

🧵 Side Projects & Creativity<br>
&nbsp;&nbsp;👕 FLEMME — Création de marque : designs, sérigraphie, automatisations marketing.<br>
&nbsp;&nbsp;🏐 La Manchette Rose — Projet associatif & communication web.<br>


## 🌐 Socials:
[![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://www.linkedin.com/in/adrien-gavazzi-data/) 
